...
import { gem, makeInIndia, nav, site, social } from "@/content/site";
  ...
  return (
    <footer className="bg-[#eef1f4] text-ink">
      <Container className="py-14 sm:py-16 lg:py-20">
        ...
        <div className="mt-12 grid gap-12 border-t border-line pt-12 text-center md:grid-cols-2 lg:mt-14 lg:grid-cols-4 lg:gap-8 lg:pt-14">
          ...
          <FooterBlock title="Make in India">
            <a
              href={makeInIndia.href}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex flex-col items-center gap-4"
            >
              <span className="inline-flex bg-ink p-3">
                <Image
                  src={makeInIndia.logo}
                  alt={makeInIndia.name}
                  width={320}
                  height={400}
                  className="h-28 w-auto sm:h-32"
                />
              </span>
              <span className="max-w-[16rem] text-base text-muted">{makeInIndia.tagline}</span>
            </a>
          </FooterBlock>
          ...
          <FooterBlock title="Follow us">
            ...
            <p className="mt-4 max-w-[16rem] text-base text-muted">Follow us on our social media</p>
          </FooterBlock>
          ...
          <FooterBlock title="GeM">
            <a
              ...
              className="inline-flex flex-col items-center gap-4"
            >
              <span className="inline-flex bg-paper p-3">
                <Image
                  src={gem.logo}
                  alt={gem.name}
                  width={360}
