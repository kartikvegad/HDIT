...
export function People() {
  return (
    <section id="people" className="bg-paper py-16 sm:py-20 lg:py-24">
      <Container>
        <div className="grid gap-12 lg:grid-cols-12">
          <Reveal className="lg:col-span-5">
            <SectionLabel label={people.label} />
            <h2 className="type-display mt-8">{people.headline}</h2>
          </Reveal>
          <Reveal delay={80} className="flex flex-col justify-end lg:col-span-7">
            <p className="max-w-2xl text-lg leading-relaxed text-muted">{people.body}</p>
          </Reveal>
        </div>
